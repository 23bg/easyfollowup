...
export const metadata: Metadata = {
    title: "Terms - EasyFollowUp",
    description: "Terms of service for EasyFollowUp subscriptions and usage.",
};
        ...
        <>
            ...
            <main className="mx-auto w-full max-w-4xl px-4 py-12 md:px-6 lg:py-16">
                ...
                <div className="mt-6 space-y-4 text-sm text-muted-foreground">
                    <p>EasyFollowUp is provided as a subscription SaaS product for coaching institute operations.</p>
                    ...
                    <p>Using EasyFollowUp indicates acceptance of these terms and future policy updates.</p>
                </div>
            </main>
            <Footer />
        </>
