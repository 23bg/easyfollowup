...
export const metadata: Metadata = {
    title: "Privacy Policy - EasyFollowUp",
    description: "Privacy policy for EasyFollowUp users and institutes.",
};
        ...
        <>
            ...
            <main className="mx-auto w-full max-w-4xl px-4 py-12 md:px-6 lg:py-16">
                ...
                <div className="mt-6 space-y-4 text-sm text-muted-foreground">
                    <p>EasyFollowUp collects only the data required to provide admissions, student, fees, and payment workflows for institutes.</p>
                    ...
                    <p>By using EasyFollowUp, you consent to this policy and related product terms.</p>
                </div>
            </main>
            <Footer />
        </>
